return {
	Weapons = {
		...
		['WEAPON_RAYCARBINE'] = {
			label = 'Mitrailleuse sacrée infernale',
			weight = 3620,
			durability = 0.2,
			ammoname = 'ammo-laser'
		},
	...
	Components = {
		...
		['at_clip_extended_smg'] = {
			label = 'Chargeur étendu pour SMG',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_clip_extended_shotgun'] = {
			label = 'Chargeur étendu pour fusil à pompe',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_clip_extended_rifle'] = {
			label = 'Chargeur étendu pour fusil',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_clip_extended_sniper'] = {
			label = 'Chargeur étendu pour sniper',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_clip_drum_shotgun'] = {
			label = 'Tambour pour fusil à pompe',
			type = 'magazine',
			weight = 280,
			client = {
				component = {
		...
		['at_scope_nv'] = {
			label = 'Lunette de vision nocturne',
			type = 'sight',
			weight = 420,
			client = {
				component = {
